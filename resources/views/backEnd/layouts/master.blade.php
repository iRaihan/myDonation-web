...
<head>
  ...
  <link rel="stylesheet" href="{{asset('public/backEnd/')}}/dist/css/customs_style.css">
  <!-- iCheck -->
...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand bg-color navbar-light border-bottom">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          Notification<i class="fa fa-bell-o"></i>
          <span class="badge badge-warning navbar-badge">15</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">Notifications</span>
          <div class="dropdown-divider"></div>
          <a href="{{url('/admin/event/alart')}}" class="dropdown-item">
            <i class="fa fa-envelope mr-2"></i> Event
            <?php
            $all_event=\App\All_service::all()->where('alart','=',450);
            $i=1;
            $sum=0;
            ?>
            @foreach($all_event as $total)
             <?php
              $sum=$sum+$i;
              ?>
            @endforeach
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/add/services/category')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Add Services</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/add/sub/services')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Add Sub-Services</p>
                </a>
              </li>
            </ul>
          </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/admin/add/causes')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Add</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/admin/view/all_causes')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Manage</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/admin/causes/request')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Cause Request</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('/admin/donate/check')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Confirmation Manage</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/admin/todays/check')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
           ...
           <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/admin/view_volunteer_list')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>View</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/admin/fund/add')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Add</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/admin/fund/manage')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Manage</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/admin/add/bank_patnar')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Add</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/admin/manage/bank_patner')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Manage</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/admin/causes/event/alert')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Causes Event Alerts</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/admin/service/event/alert')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Services Event Alerts</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/admin/ongoing/event')}}" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Ongoing Events</p>
                </a>
              </li>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="logout-form">
      ...
      <a href="#"><i class="fa fa-cog" aria-hidden="true"></i>Change Password</a>
...
<script src="{{asset('public/backEnd/')}}/plugins/jquery/customs.js"></script>
